// @ts-nocheck
"use client";
import { financeSidebar } from "@/utils/data";
import Link from "next/link";
import { usePathname } from "next/navigation";
import { Menu, MenuItem, Sidebar, SubMenu } from "react-pro-sidebar";

const ProviderFinanceSidebar = ({ toggled, setToggled, setBroken, broken }) => {
                  ...
                  <MenuItem
                    ...
                    icon={
                      <subitem.Icon
                        size={20}
                        color={
                          pathName === subitem.link ? "white" : subitem.color
                        }
                        className={`${subitem.color}`}
                      />
                    }
...
export default ProviderFinanceSidebar;
